...
function random(){
    ...
    for (var i = 0; i < 9; i++){
        ...
        partidos[i].getElementsByTagName("span")[r].style.backgroundColor = "rgb(234, 255, 0)";
        res[i] = ["L","E","V"][r];
    }
    container.innerHTML = res.join("\xa0\xa0");
    costoactual();
...
function send(){				//Envia la quiniela al whatsapp 
    ...
    window.location.href = "https://wa.me/52524498476015?text="+whatsapptext;}
}
